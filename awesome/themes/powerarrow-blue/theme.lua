    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            arrow(alpha, alpha),
            arrow(theme.bg_normal, "#FF8F8F"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#FF8F8F"),
            arrow("#FF8F8F", "#777AC4"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#777AC4"),
            arrow("#777AC4", "#FF8F8F"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#FF8F8F"),
            arrow("#FF8F8F", "#777AC4"),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, 4, 4), "#777AC4"),
            arrow("#777AC4", "#FF8F8F"),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#FF8F8F"),
            arrow("#FF8F8F", "#777AC4"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#777AC4"),
            arrow("#777AC4", "#FF8F8F"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#FF8F8F"),
            arrow("#FF8F8F", "alpha"),
            --]]
            s.mylayoutbox,
        },
